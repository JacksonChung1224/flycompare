          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            ...
            <div className="flex items-center gap-2 flex-1 justify-center sm:justify-start">
              ...
              <div className="flex flex-col items-center gap-0.5 px-2 flex-1 max-w-[150px]">
                ...
                <span className="text-[10px] text-muted-foreground">{flight.stops === 0 ? '直飛' : `${flight.stops} 次停靠`}</span>
              </div>
              <div className="relative flex flex-col items-center">
                ...
                {getDayDiff(flight.departure_time, flight.arrival_time) > 0 && (
                  <span className="absolute -top-1 -right-4 text-[10px] text-amber-500 font-semibold">+{getDayDiff(flight.departure_time, flight.arrival_time)}</span>
                )}
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 pt-4 border-t border-border/40">
              ...
              <div className="flex items-center gap-2 flex-1 justify-center sm:justify-start">
                ...
                <div className="flex flex-col items-center gap-0.5 px-2 flex-1 max-w-[150px]">
                  ...
                  <span className="text-[10px] text-muted-foreground">{flight.return_flight.stops === 0 ? '直飛' : `${flight.return_flight.stops} 次停靠`}</span>
                </div>
                <div className="relative flex flex-col items-center">
                  ...
                  {getDayDiff(flight.return_flight.departure_time, flight.return_flight.arrival_time) > 0 && (
                    <span className="absolute -top-1 -right-4 text-[10px] text-amber-500 font-semibold">+{getDayDiff(flight.return_flight.departure_time, flight.return_flight.arrival_time)}</span>
                  )}
                </div>
              </div>
            </div>
